---
title: "R Semester Project Proposal"
subtitle: "GEOG346"
...
output:
  prettydoc::html_pretty:
    ...
    css: unit.css
vignette: >
  %\VignetteIndexEntry{R Semester Project Proposal}
...
be displayed using the packages Shiny and Plotly, which both have the 
capabilities to create interactive maps and charts. Shiny will be used to create
...
dashboard will also give the user the ability to choose what information they 
want to see (i.e. cases, deaths, hot spots, etc.). Hot spots will be developed 
for Shiny using the Hotspot R package. Additional options like whether the user 
wants to query out a specific state/county will be included. For plotly, we will
be doing a similar visualization set-up as we will compare and contrast it with 
Shiny on how it  COVID-19 case/death data. The benefit of using a package such 
as Plotly is its ability to create professional looking graphs and charts, with 
a high level of customization. Scatter plots can be used to show a temporal
analysis of the US or a specific state or county. Similar to Shiny, there is a 
level of interactivity which allows the user to select specific settings, move 
sliders, pick from a list of choices, etc. that changes the display in 
interesting ways.

## Code

-Create branches for COVID-19 dataset for both Shiny and Plotly portions of the 
project.

-Test out functionality of both Shiny (Zoe’s portion of project) and Plotly 
...
-Creation of interactive graphs and charts of the COVID-19, with developed 
symbology and interactive capabilities. (Olivia)

-Display Shiny and Plotly visualizations on Github Pages web space. 
(Zoe and Olivia)
...
### Broad Timeline
Week 1 (04/20/20): Work with packages and have test output 
...
-We will have quality interactive data visualization interfaces, using the Shiny
and Plotly R packages, displaying continuously updated JHU COVID-19 data.
 
-Create simple Github Pages project and embed data visualization applications on 
the platform.
