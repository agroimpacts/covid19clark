...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.width=8.5, fig.height= 4.5}
...
fig1 <- fig1 %>% layout(title= "Coronavirus Cases by U.S. County",
     geo=g
)
...
fig1
```
An Example of One of the Four Maps Created with Plotly 
...
![Display of COVID-19 Cases Per State on a Leaflet Map of the US](figures/shinyapppic.png)



![COVID-19 Data Visualizations by State](figures/shinyapppic2.png)



![COVID-19 Data Table Sorted by State](figures/shinyapppic3.png)
