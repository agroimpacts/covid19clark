...
us_cases_daily$state %>% as_tibble %>% filter(state2 == "ma") %>% 
  filter(date == max(date)) %>% summarize(sum(cases))
us_cases_daily$state %>% as_tibble %>% filter(state2 == "ma") %>% 
  filter(date == max(date)) %>% summarize(sum(deaths))
us_cases_daily$state %>% as_tibble %>% filter(state2 == "ny") %>% View
